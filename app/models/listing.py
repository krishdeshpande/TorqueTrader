...
# Import VerificationLog so SQLAlchemy registers it alongside Listing.
# The model itself now lives in app.models.verification.
from app.models.verification import VerificationLog  # noqa: F401, E402
